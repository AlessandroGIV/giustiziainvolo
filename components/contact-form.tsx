...
const ContactForm = () => {
  ...
  // Load Google Global Site Tag (gtag.js)
  // This will load the script and initialize gtag
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        } else if (msg.includes('Template not found')) {
          setError("Template email non trovato. Contatta l'amministratore del sito.")
        } else if (msg.includes('non è caricato')) {
          setError("Servizio email non caricato. Ricarica la pagina e riprova.")
        } else {
          setError(`Errore: ${msg}. Contatta info@giustiziainvolo.it direttamente.`)
        }
      } else {
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          <Label htmlFor="phone">Telefono (opzionale per essere ricontattato)</n        ...
